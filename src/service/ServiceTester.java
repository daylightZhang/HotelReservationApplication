...
public class ServiceTester {
    public static void main(String[] args) {
        /*
        CustomerService.addCustomer("ddd","zz","fff");
        CustomerService.addCustomer("ddd2","zz2","fff2");
        CustomerService.addCustomer("ddd3","zz3","fff3");
        CustomerService.addCustomer("ddd4","zz4","fff4");

        ArrayList<Customer> database = (ArrayList<Customer>) CustomerService.getAllCustomer();
        Iterator<Customer> it = database.iterator();
        while (it.hasNext()) {
            System.out.println(it.next());
        }

        Customer c = CustomerService.getCustomer("fff4");
